...
const SkeletonLoader = () => (
  <div className="relative w-full min-h-screen overflow-hidden bg-gradient-to-br from-[#2a1810] via-[#3d2617] to-[#1a0f08] flex items-center justify-center">
    <div className="w-full max-w-2xl px-4">
      <div className="relative bg-gradient-to-br from-[#3d2617]/90 to-[#2a1810]/90 backdrop-blur-sm border border-[#d4a574]/30 p-6 sm:p-8 md:p-12 lg:p-16 shadow-2xl rounded-lg">
...
const EarlyAccessPage = () => {
  ...
  return (
    <div className="relative w-full min-h-screen overflow-hidden bg-gradient-to-br from-[#2a1810] via-[#3d2617] to-[#1a0f08]">
      ...
      <svg
        className="hidden sm:block absolute top-10 left-10 w-12 h-12 sm:w-16 sm:h-16 opacity-10"
        viewBox="0 0 24 24"
        fill="none"
        stroke="#d4a574"
        strokeWidth={2}
      ...
      <svg
        className="hidden md:block absolute top-20 right-20 w-12 h-12 sm:w-14 sm:h-14 opacity-8"
        viewBox="0 0 24 24"
        fill="none"
        stroke="#d4a574"
        strokeWidth={2}
      ...
      <svg
        className="hidden sm:block absolute bottom-20 left-1/4 w-8 h-8 sm:w-10 sm:h-10 opacity-10"
        viewBox="0 0 24 24"
        fill="none"
        stroke="#d4a574"
        strokeWidth={2}
          ...
          <AnimatePresence mode="wait">
            {!isSubmitted ? (
              ...
              >
                ...
                <div className="relative bg-gradient-to-br from-[#3d2617]/90 to-[#2a1810]/90 backdrop-blur-sm border border-[#d4a574]/40 p-6 sm:p-8 md:p-12 lg:p-16 shadow-2xl text-center rounded-lg">
