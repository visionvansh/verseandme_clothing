            ...
            {!isSubmitted ? (
              ...
              >
                ...
                <div className="relative bg-gradient-to-br from-gray-100 to-gray-200 backdrop-blur-sm border border-gray-300 p-6 sm:p-8 md:p-12 lg:p-16 shadow-2xl rounded-lg">
                  ...
                  <div className="text-center mb-6 sm:mb-8">
                    <h4
                      className="text-2xl sm:text-2xl md:text-2xl lg:text-3xl font-bold text-gray-800 mb-2 tracking-tight"
                    >
                      JOIN THE VERSEANDME FAMILY
                    </h4>
                    <p
                      className="text-base sm:text-lg md:text-xl text-gray-600 font-light tracking-wider"
                    >
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5 sm:space-y-6">
                    ...
                    <motion.button
                      ...
                      className="w-full bg-gradient-to-r from-gray-500 to-gray-600 text-white px-6 py-3.5 sm:py-4 text-base sm:text-lg font-bold tracking-wide relative overflow-hidden transition-all duration-300 disabled:opacity-60 disabled:cursor-not-allowed rounded-lg shadow-lg hover:shadow-gray-400"
                    >
                      {isLoading ? (
                  ...
                  {/* Privacy Note */}
                  <p
                    className="text-center text-gray-500 text-xs sm:text-sm mt-6 px-2"
                  >
                    <svg
              ...
              >
                ...
                <div className="relative bg-gradient-to-br from-gray-100 to-gray-200 backdrop-blur-sm border border-gray-300 p-6 sm:p-8 md:p-12 lg:p-16 shadow-2xl text-center rounded-lg">
                  ...
                  {/* Success Message */}
                  <h2
                    className="text-xl sm:text-2xl md:text-4xl font-bold text-gray-800 mb-4 sm:mb-6"
                  >
                  ...
                  <p
                    className="text-gray-600 text-base sm:text-lg md:text-xl mb-6 leading-relaxed px-2"
                  >
                    {registeredEmail && (
                  ...
                  <p
                    className="text-gray-500 text-sm sm:text-base mb-8 px-2 max-w-lg mx-auto"
                  >
